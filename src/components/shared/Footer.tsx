...
const Footer = () => {
    return (
        <footer className="w-full container mx-auto flex items-center bg-[#212121] h-[326px]">
               ...
               <div className="w-full text-2xl py-3 flex flex-wrap items-center ">
                ...
                <div className="w-full flex justify-start content-center flex-wrap">
                    ...
                    <label className="flex w-full flex-wrap py-3 pe-3">
                        <input type="email" name="email" id="email" placeholder="Email" className="p-1 bg-transparent border rounded w-full" />
                    </label>
                    <div className="flex w-full ">
                        <button className="bg-blue-600 text-white rounded py-1 px-3">Submit</button>
                    </div>
                </div>
            </div>
